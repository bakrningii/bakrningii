                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            ...
                            <article style={{ marginBottom: '10px' }}>From the moment we met, something in my life shifted, like the universe quietly guiding me towards something meant for me. You brought warmth into the parts of me I didn’t even know were cold, and you expanded my days with a dimension only I can call my own.</article>
                            <article style={{ marginBottom: '10px' }}>On your special day, I just want you to know this: I want you with me in every chapter, every storm, every sunshine, every tomorrow. No matter what comes, I’ll be by your side, always. I’ll choose you, protect you, stand with you, and love you in ways that remind you you’re never alone. In Shaa Allah.</article>
                            <article style={{ marginBottom: '10px' }}>You’re not just another year older today… <br />
                                You’re the reason my life feels softer, brighter, and worth living. Happy birthday my love ❤️</article>
                        </div>
                        ...
                        <p className="signature">
                            Your husband, In Shaa Allah Abubakar Mahmoud Ningi 
                        </p>
                    </div>
                </div>
            </div>
